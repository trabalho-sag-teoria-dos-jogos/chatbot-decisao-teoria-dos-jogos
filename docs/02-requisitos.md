...
| RF09 | O sistema deve apresentar ao usuário uma recomendação em linguagem natural, explicando o raciocínio por trás do resultado. | Alta |
...
- A recomendação final é compreensível por alguém sem formação em teoria dos jogos.
